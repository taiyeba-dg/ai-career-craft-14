    ...
    <Layout>
      ...
      <section className="bg-gradient-to-b from-primary/5 to-background">
        <div className="container section-padding text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About ResumeAI</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Founded in 2024, ResumeAI was born from a simple observation: talented people were losing opportunities because of poorly formatted resumes. We believe everyone deserves access to the same quality of career tools that executive coaches charge thousands for.
            </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {team.map((m, i) => (
            <Card key={i} className="text-center hover-lift">
              <CardContent className="p-6">
                <div className="w-20 h-20 rounded-full bg-primary/10 text-primary flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  {m.initials}
                </div>
      ...
      <section className="bg-secondary/50">
        <div className="container py-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 opacity-40 text-2xl font-bold">
