...
import { FadeInUp, StaggerContainer, StaggerItem, ScaleIn } from '@/components/AnimatedElements';
...
const steps = [
  ...
  { icon: Download, title: "Export & Apply", description: "Choose a template, customize the design, and export as PDF. You're ready to apply!" },
];
        ...
        <div className="container relative section-padding text-center">
          <FadeInUp>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
              ...
              Open source & free — trusted by 100,000+ professionals
            </div>
          </FadeInUp>
          <FadeInUp delay={0.1}>
